...
def save_or_update_entry():
    ...
    rgb_input = " ".join(entry_rgb.get().split())  # Entfernt überflüssige Leerzeichen
    print("Processed rgb_input:", rgb_input)
    ...
    if existing_nation:
        ...
        existing_nation["rgb"] = rgb_input.replace(" ", ",")
        ...
        nation_data = {
            ...
            "tag": tag,
            "clong": land,
            "rgb": rgb_input.replace(" ", ",") if rgb_input else "",
            "leader_trait": trait,
            "leader_name": leader,
            "traits": traits_list,
